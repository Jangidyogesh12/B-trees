...
- [ ] 2. [Day-Wise Roadmap](#day-wise-roadmap)
  ...
  - [x] [Day 24: Panic And Unrecoverable Errors](#day-24-panic-and-unrecoverable-errors)
  - [x] [Day 25: Iterators](#day-25-iterators)
  - [x] [Day 26: Closures](#day-26-closures)
  - [x] [Day 27: Modules And Visibility](#day-27-modules-and-visibility)
  - [x] [Day 28: Testing](#day-28-testing)
  - [x] [Day 29: `Box<T>`](#day-29-boxt)
  - [x] [Day 30: `Rc<T>`](#day-30-rct)
  - [x] [Day 31: `RefCell<T>` And Interior Mutability](#day-31-refcellt-and-interior-mutability)
  - [x] [Day 32: `Rc<RefCell<T>>`](#day-32-rc-refcellt)
